...
var app = express()
var Contentstack = require('../src/index.js')
...
app.get('/', (req,res)=>{
    //q9
    Stack.contentType('blogs').query().where('author', 'Chris Bucholtz').lessThan("created_at","2018-06-22").includeCount().includeContentType()
    .tags(['AI'])
    .find()
    ...
    //q3
    // Stack.assets().find().then(function(result){
    //     console.log("res",result)
    //     res.json(result)
    // })
